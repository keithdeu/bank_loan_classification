...
Instructions for running the following R files: XGBoost.Rmd, RF_SH.R, SV_Code_Logistic_Regression.R, and svm_knn_model_v2.R
...
4. Run code as needed.

The final report PDF file contains detailed descriptions on the data overall business problem, the data cleaning process, model creation, and conclusions/final thoughts.